...
global.caption = process.env.CAPTION || global.caption || "Mwtutech" 
...
global.userImages= process.env.USER_IMAGES || "https://telegra.ph/file/5f106289f3017ec491934.jpg" // "text" // set Image/video urls here
...
global.scan = "HRKU-c7b040c0-4272-4fe8-b5c2-36da145e4683";
...
module.exports = {
  ...
  caption : global.caption || "𝗠𝗪𝗧𝗨-𝗠𝗗" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "",
  packname: process.env.PACK_NAME || "",
  botname : process.env.BOT_NAME  || "Mwtutech",
  ownername:process.env.OWNER_NAME|| "Mwtutech",
